...
<head>
	...
	<?php else: ?>
		<meta property="og:title" content="<?= $page->title()->html() ?> | <?php echo $site->title()->html() ?>" />
		<meta itemprop="name" content="<?= $page->title()->html() ?> | <?php echo $site->title()->html() ?>">
	<?php endif ?>
	<meta property="og:type" content="website" />
	<meta property="og:url" content="<?= html($page->url()) ?>" />
	<?php if($page->content()->name() == "project"): ?>
		<?php if (!$page->featuredimg()->empty()): ?>
			<meta property="og:image" content="<?= resizeOnDemand($page->image($page->featuredimg()), 1200) ?>"/>
		<?php endif ?>
	<?php else: ?>
